...
BaseNoteDimensions: tuple[int] = (0, 0)

def init():
    global TapNoteImg, DragNoteImg, TapNoteSnd, DragNoteSnd, BaseNoteDimensions
    TapNoteImg = pg.transform.scale_by(pg.image.load("assets/tap.png").convert_alpha(), 0.75)
    DragNoteImg = pg.transform.scale_by(pg.image.load("assets/drag.png").convert_alpha(), 0.75)
